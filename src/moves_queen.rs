...
use crate::moves_bishop::{
    generate_bishop_attacked_squares_excluding_own, generate_bishop_attacked_squares_including_own,
    generate_bishop_pinned_piece, generate_bishop_pinned_ray,
};
use crate::moves_rook::{
    generate_rook_attacked_squares_excluding_own, generate_rook_attacked_squares_including_own,
    generate_rook_pinned_piece, generate_rook_pinned_ray,
};
...
pub fn generate_queen_attacked_squares_excluding_own(from_square: usize, game: &Game) -> u64 {
    generate_bishop_attacked_squares_excluding_own(from_square, game)
        | generate_rook_attacked_squares_excluding_own(from_square, game)
}
