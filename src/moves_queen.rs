...
pub fn generate_queen_absolute_pins(from_square: usize, game: &Game, king_bit: u64) -> Vec<u64> {
    let mut absolute_pins = generate_bishop_absolute_pins(from_square, game, king_bit);
